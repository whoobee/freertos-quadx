...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=BSW/hardware_config.c BSW/utils.c BSW/main.c BSW/software_config.c BSW/os_quad_hook.c BSW/os_quad_task.c BSW/os_quad_timer.c LLD/i2c_driver.c LLD/ic_driver.c LLD/pwm_driver.c LLD/sensors.c LLD/uart_driver.c OS/Config/ConfigPerformance.c OS/Kernel/croutine.c OS/Kernel/list.c OS/Kernel/queue.c OS/Kernel/tasks.c OS/Kernel/timers.c OS/portable/MemMang/heap_1.c OS/portable/MPLAB/PIC32MX/port.c OS/portable/MPLAB/PIC32MX/port_asm.S

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/BSW/hardware_config.o ${OBJECTDIR}/BSW/utils.o ${OBJECTDIR}/BSW/main.o ${OBJECTDIR}/BSW/software_config.o ${OBJECTDIR}/BSW/os_quad_hook.o ${OBJECTDIR}/BSW/os_quad_task.o ${OBJECTDIR}/BSW/os_quad_timer.o ${OBJECTDIR}/LLD/i2c_driver.o ${OBJECTDIR}/LLD/ic_driver.o ${OBJECTDIR}/LLD/pwm_driver.o ${OBJECTDIR}/LLD/sensors.o ${OBJECTDIR}/LLD/uart_driver.o ${OBJECTDIR}/OS/Config/ConfigPerformance.o ${OBJECTDIR}/OS/Kernel/croutine.o ${OBJECTDIR}/OS/Kernel/list.o ${OBJECTDIR}/OS/Kernel/queue.o ${OBJECTDIR}/OS/Kernel/tasks.o ${OBJECTDIR}/OS/Kernel/timers.o ${OBJECTDIR}/OS/portable/MemMang/heap_1.o ${OBJECTDIR}/OS/portable/MPLAB/PIC32MX/port.o ${OBJECTDIR}/OS/portable/MPLAB/PIC32MX/port_asm.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/BSW/hardware_config.o ${OBJECTDIR}/BSW/utils.o ${OBJECTDIR}/BSW/main.o ${OBJECTDIR}/BSW/software_config.o ${OBJECTDIR}/BSW/os_quad_hook.o ${OBJECTDIR}/BSW/os_quad_task.o ${OBJECTDIR}/BSW/os_quad_timer.o ${OBJECTDIR}/LLD/i2c_driver.o ${OBJECTDIR}/LLD/ic_driver.o ${OBJECTDIR}/LLD/pwm_driver.o ${OBJECTDIR}/LLD/sensors.o ${OBJECTDIR}/LLD/uart_driver.o ${OBJECTDIR}/OS/Config/ConfigPerformance.o ${OBJECTDIR}/OS/Kernel/croutine.o ${OBJECTDIR}/OS/Kernel/list.o ${OBJECTDIR}/OS/Kernel/queue.o ${OBJECTDIR}/OS/Kernel/tasks.o ${OBJECTDIR}/OS/Kernel/timers.o ${OBJECTDIR}/OS/portable/MemMang/heap_1.o ${OBJECTDIR}/OS/portable/MPLAB/PIC32MX/port.o ${OBJECTDIR}/OS/portable/MPLAB/PIC32MX/port_asm.o

# Source Files
SOURCEFILES=BSW/hardware_config.c BSW/utils.c BSW/main.c BSW/software_config.c BSW/os_quad_hook.c BSW/os_quad_task.c BSW/os_quad_timer.c LLD/i2c_driver.c LLD/ic_driver.c LLD/pwm_driver.c LLD/sensors.c LLD/uart_driver.c OS/Config/ConfigPerformance.c OS/Kernel/croutine.c OS/Kernel/list.c OS/Kernel/queue.c OS/Kernel/tasks.c OS/Kernel/timers.c OS/portable/MemMang/heap_1.c OS/portable/MPLAB/PIC32MX/port.c OS/portable/MPLAB/PIC32MX/port_asm.S
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/Quad_FreeRTOS.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
